    ...
    <article className={isBuilder ? 'max-w-3xl' : 'max-w-[var(--theme-prose)]'}>
      ...
      {hasCase ? (
        <dl className={isBuilder ? 'mb-10 grid gap-4' : 'mb-10 grid gap-8'}>
          {project.problem ? (
            <div className={isBuilder ? 'rounded-theme border border-line bg-panel p-4' : 'border-t border-line pt-4'}>
              <dt className={isBuilder ? 'mb-1 font-mono text-xs text-accent' : 'mb-2 font-display text-2xl'}>
                {ui.caseProblem}
              </dt>
